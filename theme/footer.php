    ...
    <div class="col-xs-12 ">
      <div class="col-xs-12 module-footer custom">
        <div class="col-xs-12 section-background">
          <img src="https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Homepage_Assets/footer_bg.jpg" loading="lazy" alt class="img-responsive">
        </div>
        <div class="col-xs-12 footer-top">
          <div class="col-xs-12 ry-container">
            <div class="col-xs-12 content">
              <div class="col-xs-12 ry-flex">
                <div class="col-xs-12 col-lg-4 each each-1" data-aos-duration="1500" data-aos="fade-right">
                  <div class="col-xs-12 wrapper">
                    <div class="col-xs-12 photo">
                      <img src="https://static.royacdn.com/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/Homepage_Assets/zellig_new_logo.png" loading="lazy" alt class="img-responsive">
                    </div>
                ...
                <div class="col-xs-12 col-lg-4 each each-2" data-aos-duration="1500" data-aos="fade-up" data-aos-delay="500">
                  <div class="col-xs-12 wrapper">
                    ...
                    <div class="col-xs-12 details">
                      ...
                      <div class="text phone"><a href="tel:2153181821" target="_self">(215) 318-1821</a></div>
                    </div>
                    <div class="col-xs-12 details">
                      <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 640 640">
                      ...
                      <div class="text phone">(215) 318-1821</div>
                    </div>
                    <div class="col-xs-12 details">
                      ...
                      <div class="text mail">
                          <a href="mailto:practice@zelligcare.com">practice@zelligcare.com</a>
                        </div>
                    </div>
                  </div>
                </div>
                <div class="col-xs-12 col-lg-4 each each-2" data-aos-duration="1500" data-aos="fade-left">
                  <div class="col-xs-12 wrapper">
                    ...
                    <div class="col-xs-12 details">
                      <div class="list-link">
                        <ul>
                          ...
                          <li class=" " data-active="">
                            <a href="<?php echo home_url('/services/'); ?>">Our Specialties</a>
                          </li>
                          <li class=" " data-active="">
                            <a href="<?php echo home_url('/meet-our-team/'); ?>">Our Team</a>
                          </li>
                          <li class=" " data-active="">
                            <a href="<?php echo home_url('/payment-options/'); ?>">Payment Options</a>
                          </li>
                          <li class=" " data-active="">
                            <a href="<?php echo home_url('/contact-us/'); ?>">Contact Us</a>
                          </li>
                          <li class=" " data-active="">
                            <a href="<?php echo home_url('/frequently-asked-questions/'); ?>">FAQ</a>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div class="col-xs-12 content">
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ry-left">
                <div class="theme_special_text_color">
                  <p><span class="span-2">&copy; <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. All rights Reserved. </span>
                    <a href="<?php echo home_url('/accessibility-statement/'); ?>">Accessibility Statement</a> -
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ry-right">
                <div class="col-xs-12 nopadding powered">
                  ...
                  <img src="https://static.royacdn.com/Site-2ee61591-bd3f-4b94-8583-7fc4d52f01b0/index_img/roya_logo_2017_small.png" loading="lazy" title="Roya" alt class="img-responsive" data-url="http://www.roya.com/?utm_source=zelligcare.com&amp;utm_campaign=poweredby" data-target="_blank">
                </div>
              </div>
            </div>
          </div>
...
</div> <!-- Close .site-content from header.php -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="aptModal" class="col-xs-12 ry-modal ry-form">
                    <div class="col-xs-12 ry-content">
                        <div class="ry-text">
                            <p>At Zellig, we provide the highest quality eye care to all our patients. Schedule your appointment today.</p>
                        </div>
                    </div>
                    <form id="form-apt-modal" class="cmsForm" data-hide-after-submit data-to-emails="support@zelligcare.com">
                        <div class="fieldset">
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 input-field-wrap">
                                <div class="form-group">
                                    <input data-datepicker name="Appointment_Date" type="text" placeholder="Date" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group">
...
<div class="modal fade ry-modal" id="repModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-xs-12 modal-show">
                    <div class="col-xs-12 modal-content-box">
                        <div class="heading">
                            <h2 style="text-align: center;">Thank You!</h2>
                        </div>
                        <div class="published-copy text">
                            <p style="text-align: center;">We've copied your review, after you click 'Publish' please paste your review by selecting 'ctrl' + 'v' into the review comments section.</p>
                            <div style="text-align: center;">
                                <a href="javascript:;" class="btn btn-primary ry-btn ry-btn-primary" target="_blank">Publish to Social</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Cookie Banner -->
<section class="cookie_privacy-container" style="display:none;">
    <div class="cookie_privacy-wrapper">
        <p>This website uses cookies to enhance your experience, analyze site usage, and monitor website traffic.</p>
        <div class="cookie_button-wrapper">
            <button onclick="setCookieBannerCookie(); document.querySelector('.cookie_privacy-container').style.display = 'none';">Accept</button>
        </div>
    </div>
</section>
...
<script>
    function getCookieBannerCookie() {
        const nameEQ = "cookieBannerAcknowledged" + "=";
    ...
    function setCookieBannerCookie() {
        ...
        document.cookie = "cookieBannerAcknowledged" + "=" + "yes" + expires + "; path=/";
    }

    document.addEventListener('DOMContentLoaded', function() {
        if (getCookieBannerCookie() !== "yes") {
            const banner = document.querySelector(".cookie_privacy-container");
