								...
								<div class="col-xs-12 wrapper">
									...
									<div class="col-xs-12 details">
										...
										<div class="text phone">
											<a href="tel:0123456789" target="_self">(012) 345-6789</a>
										</div>
									</div>
									<div class="col-xs-12 details">
										<div class="icon">
									...
									<div class="col-xs-12 details">
										...
										<div class="text mail">
											<a href="mailto:support@zelligcare.com" target="_self">Send Us A Message</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xs-12 col-lg-4 each each-2" data-aos-duration="1500" data-aos="fade-left">
								<div class="col-xs-12 wrapper">
									...
									<div class="col-xs-12 details">
										<div class="list-link">
											<ul>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a></li>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/about' ) ); ?>">Who We Are</a></li>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/services' ) ); ?>">What We Offer</a></li>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/services' ) ); ?>">Our Specialties</a></li>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/meet-our-team' ) ); ?>">Our Team</a></li>
												<li class=" " data-active=""><a href="<?php echo esc_url( home_url( '/payment-options' ) ); ?>">Payment Options</a></li>
												<li class=" " data-active=""><a href="https://admin.roya.com/sites/Site-656e9e6e-f19a-4ed1-9c29-85197594446c/contact-and-referrals.html">Contact Us</a></li>
											</ul>
										</div>
									</div>
								</div>
					...
					<div class="col-xs-12 content">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ry-left">
							<div class="theme_special_text_color">
								<p>
									<span class="span-2">© 2025 Zellig. All rights Reserved. </span>
									<a href="<?php echo esc_url( home_url( '/accessibility-statement' ) ); ?>" target="_self">Accessibility Statement</a> - 
									<a href="<?php echo esc_url( home_url( '/privacy-policy' ) ); ?>" target="_self">Privacy Policy</a> - 
									<a href="<?php echo esc_url( home_url( '/sitemap' ) ); ?>" target="_self">Sitemap</a>
								</p>
							</div>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ry-right">
							<div class="col-xs-12 nopadding powered">
								...
								<img src="https://static.royacdn.com/Site-2ee61591-bd3f-4b94-8583-7fc4d52f01b0/index_img/roya_logo_2017_small.png" loading="lazy" title="Roya" alt="" class="img-responsive" data-url="http://www.roya.com/?utm_source=zelligcare.com&amp;utm_campaign=poweredby" data-target="_blank" style="cursor: pointer;">
							</div>
						</div>
					</div>
				</div>
