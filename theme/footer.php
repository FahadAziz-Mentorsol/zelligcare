  <?php
/**
 * Footer template for Zellig Care theme
 */
?>
</div>
    <div id="ry-footer">
            ...
            <div class="col-xs-12 ry-container">
              <div class="col-xs-12 content">
                <div class="col-xs-12 ry-flex">
                  <div class="col-xs-12 col-lg-4 each each-1 aos-init aos-animate" data-aos-duration="1500" data-aos="fade-right">
                  ...
                  <div class="col-xs-12 col-lg-4 each each-2" data-aos-duration="1500" data-aos="fade-up" data-aos-delay="500">
                    <div class="col-xs-12 wrapper">
                      ...
                      <div class="col-xs-12 details">
                        ...
                        <div class="text mail">
                          <a href="mailto:support@zelligcare.com">Send Us A Message</a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xs-12 content">
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ry-left">
                <div class="theme_special_text_color">
                  <p><span class="span-2">&copy; 2025 Zellig. All rights Reserved. </span>
            ...
            <div class="modal-body">
                <div id="aptModal" class="col-xs-12 ry-modal ry-form">
                    <div class="col-xs-12 ry-content">
                        <div class="ry-text">
                            <p>At Zellig, we provide the highest quality mental health care to all our patients. Schedule your appointment today.</p>
                        </div>
                    </div>
                    <form id="form-apt-modal" class="cmsForm" data-hide-after-submit data-to-emails="practice@zelligcare.com">
                        <div class="fieldset">
                            <div class="col-xs-12">
